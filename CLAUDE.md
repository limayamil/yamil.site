...
**Icons are inline SVG, never a runtime library.** Two distinct kinds, and the distinction is deliberate — hairline strokes mark a discipline, solid fills mark a tool, so the two never compete at the same visual weight:
